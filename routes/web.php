...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'admin', 'as' => 'admin::', 'middleware' => 'soloAdmin'], function () {
        ...
        Route::group(['prefix' => 'enfermedades', 'as' => 'enfermedades::'], function () {
            ...
            Route::get('/agregar-solucion/{id}', ['as' => 'solution', 'uses' => 'Admin\DiseaseController@add_solution']);
        ...
        Route::group(['prefix' => 'soluciones', 'as' => 'soluciones::'], function () {
            Route::get('/listar', ['as' => 'create', 'uses' => 'Admin\SolutionController@create']);
            Route::post('/listar', ['as' => 'store', 'uses' => 'Admin\SolutionController@store']);
            Route::get('/buscar', ['as' => 'buscar', 'uses' => 'Admin\SolutionController@search']);
            Route::get('/editar/{id}', ['as' => 'edit', 'uses' => 'Admin\SolutionController@edit']);
            Route::post('/editar/{id}', ['as' => 'update', 'uses' => 'Admin\SolutionController@update']);
            Route::post('/eliminar/{id}', ['as' => 'delete', 'uses' => 'Admin\SolutionController@delete']);
        });

        // plantas
        Route::group(['prefix' => 'plantas', 'as' => 'plantas::'], function () {
            Route::get('/listar', ['as' => 'create', 'uses' => 'Admin\PlantController@create']);
            Route::post('/listar', ['as' => 'store', 'uses' => 'Admin\PlantController@store']);
            Route::get('/buscar', ['as' => 'buscar', 'uses' => 'Admin\PlantController@search']);
            Route::get('/editar/{id}', ['as' => 'edit', 'uses' => 'Admin\PlantController@edit']);
            Route::post('/editar/{id}', ['as' => 'update', 'uses' => 'Admin\PlantController@update']);
            Route::post('/eliminar/{id}', ['as' => 'delete', 'uses' => 'Admin\PlantController@delete']);
        });
     ...
     */
    Route::group(['prefix' => 'user', 'as' => 'user::', 'middleware' => 'soloAgricultor'], function () {
...
Route::get('/logoutuser', ['as' => 'logoutSessionUser', 'uses' => 'Auth\LoginController@getLogoutUser']);
Route::get('/logoutadmin', ['as' => 'logoutSessionAdmin', 'uses' => 'Auth\LoginController@getLogoutAdmin']);
...
//Route::get('/logout', ['as' => 'logoutSession', 'uses' => 'Auth\LoginController@getLogout']);
