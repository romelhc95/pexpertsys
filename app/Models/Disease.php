...
class Disease extends Model
{
    ...
    {
        return $this->belongsToMany('Tesis\Models\Solution', 'solu_diseas')->withTimeStamps();
    }
    ...
    public function scopeWhereSymptoms($query, $symptoms = [])
{
    ...
    public function scopeWhereSolutions($query, $solutions = [])
    {
        return $query->whereHas('solu_diseas', function ($query) use ($solutions) {
            $query->whereIn('solution_id', $solutions);
        });
    }
}
